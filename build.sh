...
LDFLAGS="-sASSERTIONS -sEXPORTED_RUNTIME_METHODS=FS,callMain -sINVOKE_RUN=0 -sEXPORT_ES6 -sMODULARIZE -sALLOW_MEMORY_GROWTH -sINITIAL_MEMORY=512MB -sSTACK_SIZE=64MB -sGLOBAL_BASE=64MB --embed-file $(pwd)/wasi-sysroot@wasi-sysroot" \
